...
public class LuoSiMaoUtil {
    ...
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-2ad20325ac8210224a450a1d6422a72b";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-b20130867ad4eb94219f9025a32b7fd5";//需要使用自己的APIkey
