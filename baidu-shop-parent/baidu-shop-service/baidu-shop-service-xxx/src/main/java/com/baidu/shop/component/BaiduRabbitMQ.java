...
@Component
@Slf4j
public class BaiduRabbitMQ implements RabbitTemplate.ConfirmCallback,RabbitTemplate.ReturnCallback {

    private RabbitTemplate rabbitTemplate;

    @Autowired
    public BaiduRabbitMQ(RabbitTemplate rabbitTemplate) {
    ...
    public void send(String msg , String routingKey){
        ...
        rabbitTemplate.convertAndSend(MqMessageConstant.EXCHANGE,routingKey,msg,correlationId);
    }
