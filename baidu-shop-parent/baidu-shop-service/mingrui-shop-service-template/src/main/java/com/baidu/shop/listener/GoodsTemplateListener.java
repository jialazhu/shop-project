 ...
 * @Description: TODO
 * @Author jlz
 * @Date 2020-10-12 19:19
 * @Version V1.0
 **/
@Component
@Slf4j
public class GoodsTemplateListener {
    ...
    public void save(Message message, Channel channel)throws IOException {
        ...
        //新增数据到es
        apiTemplateService.createHtmlTemplate(Integer.parseInt(new String(message.getBody())));
        //确认收到消息
    ...
    public void delete(Message message, Channel channel)throws IOException {
        ...
        //新增数据到es
        apiTemplateService.deleteTemplate(Integer.parseInt(new String(message.getBody())));
        //确认收到消息
        channel.basicAck(message.getMessageProperties().getDeliveryTag(), true);
    }
}
